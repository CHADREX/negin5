...
<!--				<span class="input-group-addon"><img src="--><?php //echo get_template_directory_uri(); ?><!--/assets/img/icon-user.png" alt="user"/></span>-->
		...
		<!-- Spam Trap -->
		<div class="anti-spam-res"><label for="trap"><?php echo esc_html__('Anti-spam','zanbil') ?></label><input type="text" name="email_2" id="trap" tabindex="-1" /></div>

		<?php do_action( 'register_form' ); ?>

		<p class="form-row">
			<?php wp_nonce_field( 'woocommerce-register' ); ?>
			<input type="submit" class="button" name="register" value="<?php esc_html_e( 'Register', 'zanbil' ); ?>" />
		</p>
