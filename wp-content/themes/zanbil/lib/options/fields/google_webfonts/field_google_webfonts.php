<?php
class zanbil_Options_google_webfonts extends zanbil_Options{	
	...
	*/
	function __construct($field = array(), $value ='', $parent){
		...
		$fonts = get_transient('zanbil-opts-google-webfonts');
		if(!is_array(json_decode($fonts))){
			...
			set_transient('zanbil-opts-google-webfonts', $fonts, 60 * 60 * 24);
