                    ...
                    <div class="border-header">
                        ...
                        <div class="col-lg-2 col-md-7 top-links-action">
                            <div class="my-account pull-right">
                                <ul>
                                    <li>
                                        <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>">حساب
                                            کاربری</a>
                                        <ul>
                                            <li>
                                            ...
                                            <li><a href="<?php echo esc_url(tm_woowishlist_get_page_link()) ?>"
                                                   title="کالاهای مورد علاقه">کالاهای مورد علاقه</a></li>
                                            <li><a href="<?php echo esc_url(tm_woocompare_get_page_link()) ?>"
