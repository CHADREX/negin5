                ...
                <div class="entry-content">
                    <div class="content-top">
                        ...
                        <div class="entry-meta-content">
                            <span class="category-blog"><i class="fa fa-folder-open"
                                                           aria-hidden="true"></i><?php the_category(', '); ?></span>
                            <?php if (has_tag()){ ?><span
                                    class="tag-blog"><?php the_tags('<span class="entry-meta-link entry-meta-tag"><span class="fa fa-tags"></span>', ', ', '</span>');
                                } ?></span>
                        ...
                        <div class="readmore"><a
                                    href="<?php echo get_permalink($post->ID) ?>"><?php esc_html_e('Read More', 'zanbil'); ?>
