...
<div class="customer-account" id="customer_login">

    <div class="login-box">

		<?php endif; ?>
        <div class="account-header">
            <img src="<?= get_template_directory_uri() ?>/assets/svg/login.svg">
            <div>
        ...
        <p id="signup-link">اگر حساب کاربری ندارید <span>ثبت نام کنید.</span></p>
		<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
    ...
    <div class="register-box">
        ...
        <div class="account-header">
            <img src="<?= get_template_directory_uri() ?>/assets/svg/register.svg">
            <div>
                <i class="fal fa-circle-notch"></i>
                <i class="fal fa-circle"></i>
                <i class="fal fa-plus"></i>
        ...
        <p id="signin-link">اگر حساب کاربری دارید <span>وارد شوید.</span></p>
    </div>
