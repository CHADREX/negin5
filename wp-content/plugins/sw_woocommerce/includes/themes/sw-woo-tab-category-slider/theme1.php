...
?>
<div class="sw-woo-tab-cat left-cate <?php echo esc_attr($elclass) ?>" id="<?php echo esc_attr( $widget_id ); ?>" >
	<div class="resp-tab" style="position:relative;">
		...
		<div class="top-tab-slider">
			...
			<div id="categories_slider_<?php echo esc_attr( $widget_id ); ?>" class="categories-responsive sw-woo-container-slider sw-list-cate-thumnail " data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>">
