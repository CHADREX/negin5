	...
	<div class="resp-tab" style="position:relative;">				
		...
		<!-- End get child category -->		
			...
			?>
				...
				?>
					<div id="<?php echo $so.'_category_id_'.$category.$id; ?>" class="woo-tab-container-slider responsive-slider loading clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>" data-mobile="2"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
