...
//var_dump( $list->posts );
if ( $list -> have_posts() ){ ?>
	<div id="<?php echo $widget_id; ?>" class="sw-woo-container-slider responsive-slider woo-slider-default loading" data-lg="<?php echo esc_attr( $columns ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>" data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
						...
						<div class="item-content">
							...
							<div class="reviews-content">
								...
								<div class="item-number-rating">
									<?php echo $review_count; _e(' Review(s)', 'smartaddons');?>
								</div>
							</div>	
							<!-- end rating  -->
