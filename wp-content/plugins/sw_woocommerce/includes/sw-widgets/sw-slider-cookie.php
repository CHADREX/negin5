 ...
 * Register Widget Woocommerce Cookie Slider
 * @author 		amir mansory
 * @version     1.0.0
 **/
if ( !class_exists('sw_cookie_slider_widget') ) {
    class sw_cookie_slider_widget extends WP_Widget {
        /**
         * Widget setup.
         */
        function __construct(){
            /* Widget settings. */
            $widget_ops = array( 'classname' => 'sw_cookie_slider_widget', 'description' => 'اسلایدر بر اساس آخرین بازدید کاربر' );

            /* Widget control settings. */
            $control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'sw_cookie_slider_widget' );

            /* Create the widget. */
            parent::__construct( 'sw_cookie_slider_widget', __('Sw Woo Slider widget', 'sw_woocommerce'), $widget_ops, $control_ops );

            /* Create Shortcode */
            add_shortcode( 'woo_cookie_slide', array( $this, 'CWS_Shortcode' ) );

            /* Create Vc_map */
            if ( class_exists('Vc_Manager') ) {
                add_action( 'vc_before_init', array( $this, 'CWS_integrateWithVC' ), 20 );
            }
        }
        ...
        function CWS_integrateWithVC(){
            ...
            vc_map( array(
                "name" => "اسلایدر محصول براساس آخرین بازدید",
                "base" => "woo_cookie_slide",
         ...
         ** Add Shortcode
         **/
        function CWS_Shortcode( $atts, $content = null ){
            ...
            ob_start();
                ...
                include( plugin_dir_path(dirname(__FILE__)).'/themes/sw-slider-cookie/default.php' );
