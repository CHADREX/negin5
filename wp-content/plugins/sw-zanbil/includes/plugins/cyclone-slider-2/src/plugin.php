...
function cs3_service_exporter( $plugin ) {
    ...
    $object = new CycloneSlider_Exporter( $plugin['data'], $plugin['zip_archive'], $plugin['export_json_file'] );
    return $object;
}
...
function cs3_service_importer( $plugin ) {
    ...
    $object             = new CycloneSlider_Importer( $plugin['data'], $plugin['imports_dir'], $wp_upload_location['path'], $plugin['zip_archive'], $plugin['import_zip_name'], $plugin['imports_extracts_dir'], $plugin['export_json_file'] );
    return $object;
}
...
function cs3_service_settings_page( $plugin ) {
    ...
    $object = new CycloneSlider_SettingsPage( $plugin['settings_page_properties'], $plugin['data'], $plugin['debug'], $plugin['view'] );
    return $object;
}
...
function cs3_service_export_page( $plugin ) {
    ...
    $object = new CycloneSlider_ExportPage( $plugin['export_page_properties']['parent_slug'], $plugin['export_page_properties']['page_title'], $plugin['export_page_properties']['menu_title'], $plugin['export_page_properties']['capability'], $plugin['export_page_properties']['menu_slug'], $plugin['data']->get_sliders(), $plugin['view'], $plugin['exporter'], $plugin['wp_content_dir'], $plugin['wp_content_url'], $plugin['export_page_properties']['transient_name'], $plugin['export_page_properties']['nonce_name'], $plugin['export_page_properties']['nonce_action'], $plugin['export_page_properties']['url'], $plugin['import_page_properties']['url'], $plugin['export_page_nextgen_properties']['url'] );
    return $object;
}
...
function cs3_service_import_page( $plugin ) {
    ...
    $object = new CycloneSlider_ImportPage( $plugin['import_page_properties']['parent_slug'], $plugin['import_page_properties']['page_title'], $plugin['import_page_properties']['menu_title'], $plugin['import_page_properties']['capability'], $plugin['import_page_properties']['menu_slug'], $plugin['data'], $plugin['view'], $plugin['import_page_properties']['nonce_name'], $plugin['import_page_properties']['nonce_action'], $plugin['importer'], $plugin['cyclone_slider_dir'], $plugin['wp_content_dir'], $plugin['wp_content_url'], $plugin['export_page_properties']['url'], $plugin['import_page_properties']['url'], $plugin['export_page_nextgen_properties']['url'] );
    return $object;
}
...
function cs3_service_export_page_nextgen( $plugin ) {
    ...
    $object = new CycloneSlider_ExportPageNextgen( $plugin['export_page_nextgen_properties']['parent_slug'], $plugin['export_page_nextgen_properties']['page_title'], $plugin['export_page_nextgen_properties']['menu_title'], $plugin['export_page_nextgen_properties']['capability'], $plugin['export_page_nextgen_properties']['menu_slug'], $plugin['view'], $plugin['exporter'], $plugin['wp_content_dir'], $plugin['wp_content_url'], $plugin['export_page_nextgen_properties']['transient_name'], $plugin['export_page_nextgen_properties']['nonce_name'], $plugin['export_page_nextgen_properties']['nonce_action'], $plugin['export_page_properties']['url'], $plugin['import_page_properties']['url'], $plugin['export_page_nextgen_properties']['url'] );
    return $object;
}
...
function cs3_service_admin( $plugin ) {
    ...
    $object = new CycloneSlider_Admin( $plugin['asset_loader'], $plugin['data'], $plugin['debug'], $plugin['view'], $plugin['nonce_name'], $plugin['nonce_action'], $plugin['url'] );
    return $object;
}
